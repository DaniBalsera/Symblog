 ...
 */
final class Version20250313162653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, blog LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, tags VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526CDAE07E97');
        $this->addSql('ALTER TABLE comment ADD user_id INT NOT NULL, DROP user, CHANGE blog_id blog_id INT NOT NULL, CHANGE approved approved TINYINT(1) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE users DROP updated_at, CHANGE nombre nombre VARCHAR(255) NOT NULL, CHANGE user user VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE perfil perfil VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD updated_at DATETIME NOT NULL, CHANGE nombre nombre VARCHAR(256) NOT NULL, CHANGE user user VARCHAR(128) NOT NULL, CHANGE email email VARCHAR(128) NOT NULL, CHANGE password password VARCHAR(128) NOT NULL, CHANGE perfil perfil VARCHAR(25) NOT NULL');
    }
}
