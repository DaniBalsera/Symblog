 ...
 */
final class Version20250313164024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE nombre nombre VARCHAR(255) NOT NULL, CHANGE user user VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE perfil perfil VARCHAR(50) NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE nombre nombre VARCHAR(256) NOT NULL, CHANGE user user VARCHAR(128) NOT NULL, CHANGE email email VARCHAR(128) NOT NULL, CHANGE password password VARCHAR(128) NOT NULL, CHANGE perfil perfil VARCHAR(25) NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    }
}
